...
Evidenciar la capacidad de resolver problemas computacionales utilizando algoritmos eficientes, analizando su comportamiento y seleccionando estrategias adecuadas según el tipo de problema.

Esta sección representa una etapa más avanzada del proceso de formación, donde no solo importa que el programa funcione, sino también cómo se comporta en términos de tiempo, memoria y estructura lógica.
